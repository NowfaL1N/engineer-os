/**
 * Python Language Overview Page
 * 
 * Displays all Python topics organized by categories.
 * Route: /coding/python
 */

import Link from "next/link"
import { getLanguageById } from "@/services/coding.service"
import { getPythonTopicsByCategory } from "@/services/coding/python-data-adapter"
import { Button } from "@/components/ui/button"

export const metadata = {
  title: "Python Programming - Coding Practice",
  description: "Learn Python programming with comprehensive tutorials and practice exercises",
}

export default function PythonLanguagePage() {
  const language = getLanguageById("python")
  const categories = getPythonTopicsByCategory()
