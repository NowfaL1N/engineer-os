/**
 * HTML Language Overview Page
 * 
 * Displays all HTML topics organized by categories.
 * Route: /coding/html
 */

import Link from "next/link"
import { getLanguageById } from "@/services/coding.service"
import { getHtmlTopicsByCategory } from "@/services/coding/html-data-adapter"
import { Button } from "@/components/ui/button"

export const metadata = {
  title: "HTML - Coding Practice",
  description: "Learn HTML with comprehensive tutorials and practice exercises",
}

export default function HtmlLanguagePage() {
  const language = getLanguageById("html")
  const categories = getHtmlTopicsByCategory()
