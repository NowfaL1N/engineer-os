/**
 * CSS Language Overview Page
 * 
 * Displays all CSS topics organized by categories.
 * Route: /coding/css
 */

import Link from "next/link"
import { getLanguageById } from "@/services/coding.service"
import { getCSSTopicsByCategory } from "@/services/coding/css-data-adapter"

export const metadata = {
  title: "CSS - Coding Practice",
  description: "Learn CSS with comprehensive tutorials and practice exercises",
}

export default function CssLanguagePage() {
  const language = getLanguageById("css")
  const categories = getCSSTopicsByCategory()
