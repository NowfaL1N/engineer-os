...
import { getCppTopicsByCategory } from "@/services/coding/cpp-data-adapter"
...
export default function CppLanguagePage() {
  const language = getLanguageById("cpp")
  const categories = getCppTopicsByCategory()
