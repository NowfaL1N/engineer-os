/**
 * Java Language Overview Page
 * 
 * Displays all Java topics organized by categories.
 * Route: /coding/java
 */

import Link from "next/link"
import { getLanguageById } from "@/services/coding.service"
import { getJavaTopicsByCategory } from "@/services/coding/java-data-adapter"
import { Button } from "@/components/ui/button"

export const metadata = {
  title: "Java Programming - Coding Practice",
  description: "Learn Java programming with comprehensive tutorials and practice exercises",
}

export default function JavaLanguagePage() {
  const language = getLanguageById("java")
  const categories = getJavaTopicsByCategory()
